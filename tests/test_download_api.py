...
def test_process_download_success():
    ...
    with patch('app.services.youtube.YouTubeService.download_and_merge', return_value=mock_return_value) as mock_download:
        with TestClient(app=app) as client:
            response = client.post('/process-download', json={
